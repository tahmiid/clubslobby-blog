...
renderSpoke({
  ...
  playstylesPara: () => `<p>A level-100 pro carries nine PlayStyle slots, but keeper PlayStyles are a short list — the Donnarumma equips Cross Claimer and 1v1 Close Down, both of whose thresholds sit inside attributes the build buys anyway. Check the full keeper set and every threshold in the <a href="/blog/pro-clubs-playstyle-requirements/">requirements tool</a>.</p>`,
