...
renderSpoke({
  ...
  playstylesPara: () => `<p>A level-100 pro carries nine PlayStyle slots. The five equipped on each build — they're on the cards above — were chosen so their unlock thresholds sit inside attributes the build buys anyway; nothing is bought for a badge. The Dembélé trades Messi's passing set for pace and delivery. Check any other PlayStyle's thresholds against this build in the <a href="/blog/pro-clubs-playstyle-requirements/">requirements tool</a>.</p>`,
