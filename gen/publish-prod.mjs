...
const POSTS = [
  ...
  { file: 'a19.html', slug: 'pro-clubs-shot-stopper-build', status: 'published',
    ...
    meta_description: 'The best Shot Stopper build in FC 26 Pro Clubs: a Buffon and a Donnarumma at level 100 — every keeper attribute, the AP order and the right specialization.',
    custom_excerpt: 'Two finished level-100 keepers — a Buffon and a Donnarumma — with the AP path and specialization order.',
    tags: ['Guides', 'Builds', 'Archetypes', 'FC 26'] },
  { file: 'a20.html', slug: 'pro-clubs-sweeper-keeper-build', status: 'published',
    ...
    meta_description: 'The best Sweeper Keeper build in FC 26 Pro Clubs: a Neuer and an Ederson at level 100 — every keeper attribute, the AP order and the right specialization.',
  ...
  { file: 'a21.html', slug: 'pro-clubs-progressor-build', status: 'published',
    ...
    meta_description: 'The best Progressor build in FC 26 Pro Clubs: a Saliba and a Cubarsí at level 100 — every centre-back attribute, the AP order and the right specialization.',
  ...
  { file: 'a22.html', slug: 'pro-clubs-boss-build', status: 'published',
    ...
    meta_description: 'The best Boss build in FC 26 Pro Clubs: a Van Dijk and a Bastoni at level 100 — every centre-back attribute, the AP order and the right specialization.',
  ...
  { file: 'a23.html', slug: 'pro-clubs-engine-build', status: 'published',
    ...
    meta_description: 'The best Engine build in FC 26 Pro Clubs: a Cucurella and a Dimarco at level 100 — every fullback attribute, the AP order and the right specialization.',
  ...
  { file: 'a24.html', slug: 'pro-clubs-marauder-build', status: 'published',
    ...
    meta_description: 'The best Marauder build in FC 26 Pro Clubs: an Alexander-Arnold and a Nuno Mendes at level 100 — every attacking-fullback attribute and the AP order.',
  ...
  { file: 'a25.html', slug: 'pro-clubs-recycler-build', status: 'published',
    ...
    meta_description: 'The best Recycler build in FC 26 Pro Clubs: the Rodri \'26 World Cup tribute and the regular Rodri at level 100 — every CDM attribute, the AP order and the right specialization.',
    custom_excerpt: 'Two finished level-100 defensive midfielders — the Rodri \'26 WC tribute and the regular Rodri — with the AP path and specialization order.',
    tags: ['Guides', 'Builds', 'Archetypes', 'FC 26'] },
  ...
  { file: 'a26.html', slug: 'pro-clubs-maestro-build', status: 'published',
    ...
    meta_description: 'The best Maestro build for FC 26 Pro Clubs: a Wirtz and a Zidane at level 100 — every attribute, the Maestro+ specialization, and the right height and AcceleRATE.',
    custom_excerpt: 'Two finished level-100 deep playmakers — a Wirtz and a Zidane — with the AP path and specialization order.',
    tags: ['Guides', 'Builds', 'Archetypes', 'FC 26'] },
  { file: 'a27.html', slug: 'pro-clubs-creator-build', status: 'published',
    ...
    meta_description: 'The best Creator build in FC 26 Pro Clubs: a De Bruyne and the Messi WC 2026 tribute at level 100 — every CAM attribute, the AP order and the right specialization.',
    custom_excerpt: 'Two finished level-100 Creators — a De Bruyne and the Messi WC 2026 — with the AP path and specialization order.',
    tags: ['Guides', 'Builds', 'Archetypes', 'FC 26'] },
  { file: 'a28.html', slug: 'pro-clubs-spark-build', status: 'published',
    ...
    meta_description: 'The best Spark build in FC 26 Pro Clubs: a Usain Bolt and a Robben \'14 at level 100 — every winger attribute, the AP order and the right specialization.',
    custom_excerpt: 'Two finished level-100 wingers — a Usain Bolt and a Robben \'14 — with the AP path and specialization order.',
    tags: ['Guides', 'Builds', 'Archetypes', 'FC 26'] },
  { file: 'a29.html', slug: 'pro-clubs-finisher-build', status: 'published',
    ...
    meta_description: 'The best Finisher build in FC 26 Pro Clubs: the Agüero 93:20 and the Suárez \'14 at level 100 — every striker attribute, the AP order and the right specialization.',
    custom_excerpt: 'Two finished level-100 strikers — an Agüero 93:20 and a Suárez \'14 — with the AP path and specialization order.',
    tags: ['Guides', 'Builds', 'Archetypes', 'FC 26'] },
  { file: 'a30.html', slug: 'pro-clubs-target-build', status: 'published',
    ...
    meta_description: 'The best Target build in FC 26 Pro Clubs: a Ronaldo and a Kane at level 100 — every striker attribute, the AP order and the right specialization.',
    custom_excerpt: 'Two finished level-100 Targets — a Ronaldo and a Kane — with the AP path and specialization order.',
    tags: ['Guides', 'Builds', 'Archetypes', 'FC 26'] },
  ...
  { file: 'a50.html', slug: 'fc27-how-to-giant-fake-shot', status: 'draft',
    ...
    tags: ['Guides', 'Skill Moves', 'FC 27'] },
  { file: 'a51.html', slug: 'fc27-how-to-stop-and-go', status: 'draft',
    ...
    tags: ['Guides', 'Skill Moves', 'FC 27'] },
  { file: 'a52.html', slug: 'fc27-how-to-drag-to-drag', status: 'draft',
    ...
    tags: ['Guides', 'Skill Moves', 'FC 27'] },
  { file: 'a53.html', slug: 'fc27-how-to-foot-to-foot', status: 'draft',
    ...
    tags: ['Guides', 'Skill Moves', 'FC 27'] },
  { file: 'a54.html', slug: 'fc27-how-to-lateral-heel-to-heel', status: 'draft',
    ...
    tags: ['Guides', 'Skill Moves', 'FC 27'] },
  { file: 'a55.html', slug: 'fc27-how-to-drag-turn', status: 'draft',
    ...
    tags: ['Guides', 'Skill Moves', 'FC 27'] },
  { file: 'a56.html', slug: 'fc27-how-to-standing-scoop-turn', status: 'draft',
    ...
    tags: ['Guides', 'Skill Moves', 'FC 27'] },
  { file: 'a57.html', slug: 'fc27-how-to-flair-roulette', status: 'draft',
    ...
    tags: ['Guides', 'Skill Moves', 'FC 27'] },
  { file: 'a58.html', slug: 'fc27-how-to-four-touch-skill', status: 'draft',
    ...
    tags: ['Guides', 'Skill Moves', 'FC 27'] },
  { file: 'a59.html', slug: 'fc27-how-to-skilled-bridge', status: 'draft',
    ...
    tags: ['Guides', 'Skill Moves', 'FC 27'] },
  { file: 'a60.html', slug: 'fc27-how-to-first-time-spin', status: 'draft',
    ...
    tags: ['Guides', 'Skill Moves', 'FC 27'] },
  { file: 'a61.html', slug: 'fc27-how-to-alternate-elastico-chop', status: 'draft',
    ...
    tags: ['Guides', 'Skill Moves', 'FC 27'] },
  { file: 'a62.html', slug: 'fc27-how-to-running-fake-drag', status: 'draft',
    ...
    tags: ['Guides', 'Skill Moves', 'FC 27'] },
  { file: 'a63.html', slug: 'fc27-control-changes', status: 'draft',
