...
export const PLAYERS = [
  { n: 87, slug: 'vinicius', name: 'Vinícius Júnior',
    intro: `Vinícius Júnior's build is the modern left winger: acceleration to attack the touchline, the touch to beat a fullback twice, and the finish once he cuts inside.` },
  { n: 88, slug: 'de-bruyne', name: 'Kevin De Bruyne',
    intro: `De Bruyne's build is the passing range that decides games — vision, a driven ball into the channel, and the shot from the edge when nobody closes him down.` },
  { n: 89, slug: 'harry-kane', name: 'Harry Kane',
    intro: `Kane's build is the complete number nine: finishing from anywhere in the box, the strength to hold it up, and the passing to drop in and start the move himself.` },
  { n: 90, slug: 'lewandowski', name: 'Robert Lewandowski',
    intro: `Lewandowski's build is the coldest finisher in the catalog — technically excellent, physically strong, and pointed at one thing.` },
  { n: 91, slug: 'modric', name: 'Luka Modrić',
    intro: `Modrić's build is the deep playmaker: the touch to turn out of pressure and the range to switch play in one pass.` },
  { n: 92, slug: 'kroos', name: 'Toni Kroos',
    intro: `The Kroos build is passing as a weapon — the metronome in front of the back four, with the long ball that reaches the far touchline.` },
  { n: 93, slug: 'ronaldo-r9', name: 'Ronaldo (R9)',
    intro: `The R9 build is the original power forward: explosive off the mark, ruthless in front of goal, and able to dribble through a defence at speed.` },
  { n: 94, slug: 'pele', name: 'Pelé',
    intro: `The Pelé build is the complete forward — finishing, dribbling and agility together, the profile everything else gets measured against.` },
  { n: 95, slug: 'roberto-carlos', name: 'Roberto Carlos',
    intro: `Roberto Carlos' build is the attacking left back nobody outran: maxed pace down the flank, and a shot from thirty yards that belongs to a striker.` },
  { n: 96, slug: 'kaka', name: 'Kaká',
    intro: `The Kaká build is the driving number ten — carrying the ball at speed from midfield into the box, and finishing what he starts.` },
  { n: 97, slug: 'ibrahimovic', name: 'Zlatan Ibrahimović',
    intro: `Zlatan's build is the target man with a technician's touch: strength and heading, on top of the ball control most forwards his size never have.` },
  { n: 98, slug: 'saka', name: 'Bukayo Saka',
    intro: `Saka's build is the inverted right winger: the cut inside onto the left foot, the curled finish, and the delivery when he goes outside instead.` },
  { n: 99, slug: 'foden', name: 'Phil Foden',
    intro: `Foden's build is the small, sharp playmaker — tight control in traffic and a left foot that finds the far corner from the edge of the area.` },
  { n: 100, slug: 'musiala', name: 'Jamal Musiala',
    intro: `Musiala's build is the dribbler who glides through midfield: agility and balance first, with the finish to make the run worth it.` },
  { n: 101, slug: 'wirtz', name: 'Florian Wirtz',
    intro: `Wirtz's build is the modern ten — the through ball, the first touch that beats a press, and the shot when the defence backs off.` },
  { n: 102, slug: 'leao', name: 'Rafael Leão',
    intro: `Leão's build is pace and power down the left: long strides into space, and the strength to hold off the fullback while he gets there.` },
  { n: 103, slug: 'bruno-fernandes', name: 'Bruno Fernandes',
    intro: `Bruno Fernandes' build is the attacking midfielder who takes risks — the pass nobody else tries, and the shot from range when it isn't on.` },
  { n: 104, slug: 'neuer', name: 'Manuel Neuer',
    intro: `The Neuer build is the sweeper keeper: the reach to make the save, and the distribution to start the attack the moment he has it.` },
  { n: 105, slug: 'davies', name: 'Alphonso Davies',
    intro: `Davies' build is a winger who defends — the quickest thing on the pitch, carrying the ball from his own half to the byline.` },
  { n: 106, slug: 'son', name: 'Son Heung-min',
    intro: `Son's build is the two-footed wide forward: elite from either side, a finisher's numbers on a winger's frame.` },
