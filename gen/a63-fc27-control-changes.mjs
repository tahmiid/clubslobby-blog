...
<h2>New in attack</h2>
<table><thead><tr><th>Action</th><th>PlayStation</th><th>Xbox</th></tr></thead><tbody>
${row('Directional Fake Shot to Stop', 'Hold R1 + ▢ or ◯ + ✕ + L direction', 'Hold RB + X or B + A + L direction')}
${row('Trigger Curved Runs', 'L1 + R1 + direction', 'LB + RB + direction')}
${row('Pass and Follow', 'L1 + R1 + ✕', 'LB + RB + A')}
</tbody></table>
...
<table><thead><tr><th>FC 26</th><th>FC 27</th><th></th></tr></thead><tbody>
...
${row('Precision Pass', '<strong>Precision Ground Pass</strong>', 'R1 + △')}
${row('Flair Lob / Cross', '<strong>Flair Lob / Cross / Outside The Foot</strong>', 'L2 + ▢')}
...
<p>The Be A Pro pages carry <strong>Call For Cross / Lob</strong> (▢),
<strong>Call for Ground Cross</strong> (R1 + ▢) and <strong>Call for High
Cross</strong> (L1 + ▢). These are not new. They are absent from the skill and
