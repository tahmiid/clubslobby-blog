...
def cheap_to_raise():
    ...
    d.text((PAD, y + 50), f'Retail cost tiers, re-read in-game 22 Sep · 90 Finishing is {ex[0]} AP on a Finisher; a Boss stops at {ex[1][1]} and even that is {ex[1][0]} AP · 962 AP at level 40',
