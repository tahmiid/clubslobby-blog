...
// The player articles carry an FC 26 legacy section (FC 27 leads since
// 2026-09-14, LAUNCH-DAY-2026-09-18.md), and the two captures name some
// actions differently, so that section must render against FC 26's own
// dataset - CONTROLS_YEAR=26 is how. Both files are exported by ops/export-controls.mjs.
...
@media(max-width:640px){
  ...
  .padsw-m{padding:10px 12px;font-size:13px}
  .padsw-c{width:34px;height:34px}
